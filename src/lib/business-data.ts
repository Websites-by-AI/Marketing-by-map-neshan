...
export const cooperationModels = [
  ...
  },
  {
    ...
    tag: "۱۰ حوزه، چند استارتاپ",
    leadRange: "وب + فروش + حقوقی + مهاجرت + آموزش",
    price: "از ۱۲ میلیون شروع",
    desc: "در هر حوزه حداقل دو استارتاپ از SBZ-EDU و Websites-by-AI است. ارجاع بعد از لید دیجیتال؛ بات محصول دیگر وصل نمی‌شود.",
    includes: [
      "وب: neshan-m + جشن‌ساز Pages",
      "فروش: LeadFair + لیدفر",
      "حقوقی: آرمان + دفتر اسناد ۶۶۲",
      "مهاجرت: immigration.exhibition2world.ir + شاهرخ Pages",
    ],
