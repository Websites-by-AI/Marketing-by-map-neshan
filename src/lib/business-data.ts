...
export const cooperationModels = [
  ...
  },
  {
    ...
    tag: "۱۲ حوزه، چند استارتاپ",
    leadRange: "غرفه + محیط‌زیست + اجتماعی",
    price: "از ۱۲ میلیون شروع",
    desc: "ده حوزه غرفه به‌علاوه محیط‌زیست و اجتماعی از Heroku-elasa. Civicavita فقط اجتماعی است نه CRM نمایشگاه.",
    includes: [
      "وب: neshan-m + جشن‌ساز Pages",
      "حقوقی: آرمان + دفتر اسناد ۶۶۲ + دادگر Heroku-elasa",
      "محیط: امید سبز + EcoSmart پسماند + آب ایران",
      "اجتماعی: آورا + جان‌پناه + Civicavita (بدون بات)",
    ],
