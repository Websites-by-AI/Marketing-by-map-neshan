...
export function buildSiteAudit() {
  ...
  const items: AuditItem[] = [
    ...
    },
    {
      id: "saadatabad",
      status: "wrong",
      title: "باقیمانده سعادت‌آباد روی پنل",
      detail: "داشبورد اول برای کلینیک/کافه غرب تهران بود. کارت‌های سعادت‌آباد / میدان کاج با عدد صفر روی حالت نمایشگاه غلط بودند و در این نسخه با آمار سالن عوض می‌شوند.",
    },
    {
      id: "iranconfair-ir",
      status: "missing",
